...
namespace Lab6.Library
{
	...
	public static class LinqDemo
	{
		...
		public static List<Student> GetTestStudents()
		{
			...
			{
				new Student("Иван", "Петров", "213", 4.5, 20),
				new Student("Мария", "Сидорова", "113", 5.0, 19),
				new Student("Алексей", "Иванов", "213", 3.8, 21),
				new Student("Елена", "Козлова", "313", 4.9, 20),
				new Student("Дмитрий", "Смирнов", "113", 4.2, 22),
				new Student("Анна", "Волкова", "313", 5.0, 19),
				new Student("Сергей", "Попов", "313", 3.5, 21),
				new Student("Ольга", "Лебедева", "213", 4.7, 20),
				new Student("Николай", "Новиков", "113", 3.9, 23),
				new Student("Татьяна", "Морозова", "313", 4.8, 19)
			};
		}
